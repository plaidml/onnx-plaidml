...
ONNX_DTYPE_TO_PLAIDML = {
    onnx_pb.TensorProto.FLOAT: plaidml.DType.FLOAT32,
    onnx_pb.TensorProto.UINT8: plaidml.DType.UINT8,
    onnx_pb.TensorProto.INT8: plaidml.DType.INT8,
    onnx_pb.TensorProto.UINT16: plaidml.DType.UINT16,
    onnx_pb.TensorProto.INT16: plaidml.DType.INT16,
    onnx_pb.TensorProto.INT32: plaidml.DType.INT32,
    onnx_pb.TensorProto.INT64: plaidml.DType.INT64,
    onnx_pb.TensorProto.BOOL: plaidml.DType.BOOLEAN,
    onnx_pb.TensorProto.FLOAT16: plaidml.DType.FLOAT16,
    onnx_pb.TensorProto.DOUBLE: plaidml.DType.FLOAT64,
    onnx_pb.TensorProto.UINT32: plaidml.DType.UINT32,
    onnx_pb.TensorProto.UINT64: plaidml.DType.UINT64,
}

_ONNX_TENSOR_DATATYPE_TO_GETTER = {
    onnx_pb.TensorProto.FLOAT: operator.attrgetter('float_data'),
    onnx_pb.TensorProto.DOUBLE: operator.attrgetter('float_data'),
    onnx_pb.TensorProto.UINT8: operator.attrgetter('int32_data'),
    onnx_pb.TensorProto.INT8: operator.attrgetter('int32_data'),
    onnx_pb.TensorProto.UINT16: operator.attrgetter('int32_data'),
    onnx_pb.TensorProto.INT16: operator.attrgetter('int32_data'),
    onnx_pb.TensorProto.UINT32: operator.attrgetter('uint64_data'),
    onnx_pb.TensorProto.INT32: operator.attrgetter('int32_data'),
    onnx_pb.TensorProto.UINT64: operator.attrgetter('uint64_data'),
    onnx_pb.TensorProto.INT64: operator.attrgetter('int64_data'),
    onnx_pb.TensorProto.STRING: operator.attrgetter('string_data'),
    onnx_pb.TensorProto.BOOL: operator.attrgetter('int32_data'),
}

_ONNX_TENSOR_DATATYPE_TO_UNPACK_TEMPLATE = {
    onnx_pb.TensorProto.FLOAT: '<{}f',
    onnx_pb.TensorProto.DOUBLE: '<{}d',
    onnx_pb.TensorProto.UINT8: '<{}B',
    onnx_pb.TensorProto.INT8: '<{}b',
    onnx_pb.TensorProto.UINT16: '<{}H',
    onnx_pb.TensorProto.INT16: '<{}h',
    onnx_pb.TensorProto.UINT32: '<{}I',
    onnx_pb.TensorProto.INT32: '<{}i',
    onnx_pb.TensorProto.UINT64: '<{}Q',
    onnx_pb.TensorProto.INT64: '<{}q',
...
def onnx_type_to_placeholder_value(type_proto):
    ...
    Args:
        type_proto (onnx_pb.TypeProto): The ONNX type proto.
